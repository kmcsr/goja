...
func (r *RequireModule) resolve(modpath string) (module *goja.Object, err error) {
...
func (r *RequireModule) loadNative(path string) (*goja.Object, error) {
...
func (r *RequireModule) loadAsFileOrDirectory(path string) (module *goja.Object, err error) {
...
func (r *RequireModule) loadAsFile(path string) (module *goja.Object, err error) {
...
func (r *RequireModule) loadIndex(modpath string) (module *goja.Object, err error) {
...
func (r *RequireModule) loadAsDirectory(modpath string) (module *goja.Object, err error) {
...
func (r *RequireModule) loadNodeModule(modpath, start string) (*goja.Object, error) {
	return r.loadAsFileOrDirectory(path.Join(start, modpath))
}

func (r *RequireModule) loadNodeModules(modpath, start string) (module *goja.Object, err error) {
...
func (r *RequireModule) createModuleObject() *goja.Object {
